...
// source: F:/JetBrains/markdown/src/commonMain/kotlin/org/intellij/markdown/flavours/gfm/lexer/gfm.flex
...
class _GFMLexer(`in`: java.io.Reader?) : GeneratedLexer {
    /** Input device.  */
    ...
    private val parseDelimited: ParseDelimited = org.intellij.markdown.flavours.gfm.lexer._GFMLexer.ParseDelimited()
    ...
    private object HtmlHelper {
        ...
        val BLOCK_TAGS: Set<String?> = org.intellij.markdown.flavours.gfm.lexer._GFMLexer.HtmlHelper.getBlockTagsSet()

        val blockTagsSet: Set<String?>
            get() {
                val result: Set<String?> = HashSet<String?>()
                val tags: Array<String?> =
                    org.intellij.markdown.flavours.gfm.lexer._GFMLexer.HtmlHelper.BLOCK_TAGS_STRING.split(", ")
                for (tag in tags) {
                    result.add(tag)
                }
                return result
    ...
    private fun isBlockTag(tagName: String): Boolean {
        return org.intellij.markdown.flavours.gfm.lexer._GFMLexer.HtmlHelper.BLOCK_TAGS.contains(tagName.lowercase())
    }
